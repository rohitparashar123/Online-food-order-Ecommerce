            ...
            <tbody>';
               <tr>
                  $subTotal=0;
                   ...
                   <tr>
                    <td class="no">'.$list['order_id'].'</td>
                    <td class="class">'.$list['product_name'].'</td>
                    <td class="desc">Rs '.$list['product_price'].'</td>
                    <td class="qty">'.$list['product_quantity'].'</td>
                    <td class="total">'.$list['product_price']*$list['product_quantity'].'</td>
                  </tr>';
